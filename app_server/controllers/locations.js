...
const renderHomepage = (req, res, responseBody) => {
  ...
  res.render('locations-list', {
    ...
    Let Loc8r help you find the place you're looking fo.",
...
const showError = (req, res, status) => {
  ...
  if (status === 404) {
    ...
    content = 'Oh dear. Looks like you can\'t find this pageXOffset. Sorry.';
  } else {
    title = `${status}, somethinng's gone wrong`;
